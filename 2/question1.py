...
greet(1)  # функция принимает только str
greet("1", "2")  # функция принимает только 1 аргумент

print(square("45"))  # функция работает корректно только с int или float
print(square(10, 10))  # функция принимает только 1 аргумент

print(max_of_two(10))  # функция принимает только 1 аргумент
print(max_of_two("3"))  # функция работает корректно только с int или float
